...
?>
    ...
    <div class="col-lg-8 sm-12">
        ...
        <div class="card shadow mb-3 bg-light">
          <h4 class="card-header">Find your career</h4>
          <div class="card-body">
            <p class="card-text">
             <?php 
             ...
             include 'connect/connect.php';
                ...
                $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE LIKE '%search-item%' or CATEGORY LIKE '%search-item%' OR LOCATION LIKE '%search-item%' or JOB_TITLE LIKE '%search-item%' ");
