...
<!-- Search Form Section Begin -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="insertJobs.php" method="post" class="filter-form">
                        <div class="first-row">
                          <div class="col form-group d-none d-lg-block">

                            <div class="row float-right">
                            <div class="col float-right">
                                <a class="btn btn-secondary" href="index.php" role="button">Dashboard</a>
                                <a class="btn btn-info" href="all.php" role="button">All Jobs</a>
                                <a class="btn btn-info" href="delete.php" role="button">Delete</a>
                            </div>
                        </div><br><br><br><br>
    ...
    <form method="post" action="insertJobs.php" id="contactform" class="form-group main-contact-form " data-wow-delay="0.2s">
        <div class="row">
            ...
            <div class="col form-group">
                <input type="text" class="form-control" name="RECRUITER" id="RECRUITER" placeholder="Recruiter">
            </div>
        </div>
        <div class="row">
        <div class="col form-group">
        ...
        <div class="col form-group">
          <select class="w-100" name="JOB_TYPE" id="JOB_TYPE">
            ...
            <option value="Internship" <?php if($type['JOB_TYPE'] == "Internship") { echo "SELECTED"; } ?>>Internship</option>
        ...
        <div class="row"> 
            <div class="col form-group">
                <input type="text" class="form-control" name="APPLY" id="APPLY" placeholder="Link to Apply"></input>
            </div>
        </div><br>
