...
<div class="container">
    ...
    <h1 class="head float-left font-weight-bold text-white align-middle align-baseline shadow p-3 mb-5">Job Offers</h1>
                        ...
                        <div class="first-row">
                          <div class="col form-group">
                            ...
                            <div class="col-lg-8 md-12 sm-12">
                                ...
                                <div class="card shadow mb-3 bg-light">
                                  <h4 class="card-header">All Offers</h4>
                                  <div class="card-body">
                                    <p class="card-text">
                                     <?php 
                                        ...
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE REF <= 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="alloffers.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>

                                <div class="card shadow mb-3 bg-light">
                                  <h4 class="card-header">Full-Time Jobs</h4>
                                  <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Full-Time' LIMIT 3");
                                    ...
                                    <a href="fulltime.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>

                                <div class="card shadow mb-3 bg-light">
                                  <h4 class="card-header">Part-Time Jobs</h4>
                                  <div class="card-body">
                                    <p class="card-text">
                                        <?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Part-Time' LIMIT 3");
                                    ...
                                    <a href="parttime.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>

                                <div class="card shadow mb-3 bg-light">
                                 <h4 class="card-header">Summer Job</h4> 
                                  <div class="card-body">
                                    <p class="card-text">
                                    <?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Summer Job' LIMIT 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="summer.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>
                                ...
                                <div class="card shadow mb-3 bg-light">
                                  ...
                                  <div class="card-body">
                                    <p class="card-text"><?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Internship' LIMIT 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="internship.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>

                                <div class="card shadow mb-3 bg-light">
                                  <h4 class="card-header">Graduate Programmes</h4>
                                  <div class="card-body">
                                    <p class="card-text"><?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Graduate Programme' LIMIT 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="graduate.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>

                                <div class="card shadow mb-3 bg-light">
                                  <h4 class="card-header">Abroad</h4>
                                  <div class="card-body">
                                    <p class="card-text">
                                        <?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Abroad' LIMIT 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="abroad.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>

                                <div class="card shadow mb-3 bg-light">
                                  <h4 class="card-header">Volunteer</h4>
                                  <div class="card-body">
                                    <p class="card-text"><?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Volunteer' LIMIT 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="volunteer.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>
                                ...
                                <div class="card shadow mb-3 bg-light">
                                  ...
                                  <div class="card-body">
                                    <p class="card-text"><?php 
                                        ...
                                        //2.  Perform Database Query
                                        $result = mysqli_query($conn,"SELECT * FROM JOBS WHERE JOB_TYPE = 'Project' LIMIT 3");
                                      ...
                                      mysqli_close($conn);
                                      ?></p>
                                    <a href="project.php" class="btn btn-info float-right">Read More >></a>
                                  </div>
                                </div>


                                <div class="card bg-light shadow p-3 mb-5">
